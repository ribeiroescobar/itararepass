...
export default function MerchantAuthPage() {
  ...
  const handleAuth = async (e: React.FormEvent, mode: "login" | "register") => {
    ...
    if (mode === "login") {
      ...
      register({ email, pass: password, name: businessName, role: "logista", additional: { businessName } }, () =>
            ...
            <TabsContent value="login" className="p-6 pt-2 space-y-6">
              <form onSubmit={(e) => handleAuth(e, "login")} className="space-y-4">
                ...
                <Button
                  ...
                  type="submit"
                  className="w-full bg-primary hover:bg-primary/90 text-white font-black h-14 rounded-2xl text-xs uppercase tracking-widest"
                >
              ...
              <form onSubmit={(e) => handleAuth(e, "register")} className="space-y-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      required
                      placeholder="Ex: Pousada das Pedras"
                      value={businessName}
